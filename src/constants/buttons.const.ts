...
export const getMoreInfoButton = new InlineKeyboard().url("📚 Узнать больше в нашем канале", "https://t.me/tarobotik");
...
export const bonusButtons = new InlineKeyboard()
    .add({ text: "🔗 Подписаться на канал", url: "https://t.me/tarobotik" }).row()
